 ...
 * @var \App\Model\Entity\Comment $first_comment
 * @var \App\Model\Entity\Comment $comment_form
 */
?>
<?= $this->Form->create($comment_form, [
...
<div class="space-y-4">
    ...
    <?= $this->Form->control('parent_id', [
        'type' => 'hidden',
        'value' => $first_comment->id
    ]) ?>

    <?= $this->Form->control('process_id', [
        'type' => 'hidden',
        'value' => $first_comment->process_id
    ]) ?>

    <?= $this->Form->control('reference_id', [
        'type' => 'hidden',
        'value' => $first_comment->reference_id
    ]) ?>
</div>
